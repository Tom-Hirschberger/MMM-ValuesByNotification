...
| groupsIcon | Specify one or more icon(s) you want to add to the groups elment either as String (which contains the [Fontawesome 4.7](https://fontawesome.com/v4/icons/) or [Iconify](https://icon-sets.iconify.design/) classes of the single icon) or a array of strings which do contain the classes. Look at in the section [Icons](doc/icons.md) for more information. | String or Array of Strings | null |
...
| debug | If set to `true` some more information will be printed to the console. | Boolean | false |
